...
class ApprovedReportsScreen extends StatefulWidget {
  const ApprovedReportsScreen({super.key});

  @override
  State<ApprovedReportsScreen> createState() => _ApprovedReportsScreenState();
}

class _ApprovedReportsScreenState extends State<ApprovedReportsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Obtener reportes aprobados de reportesGlobales y filtrar por búsqueda
    final approvedReports = supervisorProvider.reportesGlobales?.reportes
        .where((r) => r.estado == EstadoReporte.aprobada)
        .where((r) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Reportes Aprobados'),
              ...
              Expanded(
                child: supervisorProvider.isLoading
                    ...
                    : RefreshIndicator(
                        ...
                        child: approvedReports.isEmpty
                            ? _buildEmptyState()
                            : ListView.builder(
                                padding: const EdgeInsets.all(16),
                                itemCount: approvedReports.length,
                                itemBuilder: (context, index) {
                                  final reporte = approvedReports[index];
                                  return _ReportCard(
                                    reporte: reporte,
